...
export const Route = createFileRoute("/projects/task-workspace")({
  component: TaskWorkspaceApp,
  head: () => ({
    meta: [
      { title: "Task & Sprint Workspace — Live Demo | Pradip Pantha" },
      {
        name: "description",
        content: "Interactive Task & Sprint Coordination Workspace built by Pradip Pantha.",
      },
    ],
  }),
});
...
const INITIAL_TASKS: TaskItem[] = [
  {
    id: "1",
    title: "Setup TanStack Start SSR routing",
    assignee: "Pradip P.",
    priority: "High",
    status: "done",
  },
  {
    id: "2",
    title: "Build responsive Kanban board layout",
    assignee: "Pradip P.",
    priority: "High",
    status: "done",
  },
  {
    id: "3",
    title: "Integrate Framer Motion drag animations",
    assignee: "Alex M.",
    priority: "Medium",
    status: "in-progress",
  },
  {
    id: "4",
    title: "Conduct sprint check-in & blocker sync",
    assignee: "Pradip P.",
    priority: "High",
    status: "in-progress",
  },
  {
    id: "5",
    title: "Write user documentation & release notes",
    assignee: "Sarah K.",
    priority: "Low",
    status: "todo",
  },
  {
    id: "6",
    title: "QA test edge case form inputs",
    assignee: "Pradip P.",
    priority: "Medium",
    status: "review",
  },
...
function TaskWorkspaceApp() {
  const [tasks, setTasks] = useState<TaskItem[]>(INITIAL_TASKS);
  const [taskTitle, setTaskTitle] = useState("");
  const [assignee, setAssignee] = useState("Pradip P.");
        ...
        <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 pb-6 border-b border-slate-800">
          <div>
            ...
            <p className="text-sm text-slate-400 mt-1">
              Agile Task Board · Lead Engineer & Project Manager Architecture
            </p>
          </div>
