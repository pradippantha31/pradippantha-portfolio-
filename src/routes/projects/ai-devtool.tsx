...
export const Route = createFileRoute("/projects/ai-devtool")({
  ...
  head: () => ({
    meta: [
      { title: "AI Developer Workspace — Live Demo | Pradip Pantha" },
      {
        name: "description",
        content: "Interactive AI Developer Workspace & Workflow Suite built by Pradip Pantha.",
      },
    ],
  }),
});
...
function AIDevToolApp() {
  ...
  const handleRunCustomPrompt = (e: React.FormEvent) => {
    ...
    setIsProcessing(true);
    setTimeout(() => {
      setActiveOutput(`// AI Inspection Output for: "${customPrompt}"
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-8 font-sans">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          {/* Left Column: Preset Workflows & Custom Prompt */}
          ...
          {/* Right Column: Code Terminal Sandbox */}
